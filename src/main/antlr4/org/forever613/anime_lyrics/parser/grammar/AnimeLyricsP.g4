...
markup_element: (words | author_text | time_text | link | color_text | covered_text | lang_text | br | ateji | ruby | footnote_ref | keywords | description | open_graph_image /*| inline_lyrics*/);
hr: HORIZONTAL_RULE;
...
author_text: start_author markup_text end_tag;
...
open_graph_image: start_open_graph_image words end_tag;
...
start_open_graph_image: ANGLE_L OPEN_GRAPH_IMAGE ANGLE_R;
